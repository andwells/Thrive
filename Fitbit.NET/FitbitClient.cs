...
namespace Fitbit.Api
{
    ...
    public class FitbitClient : IFitbitClient
    {
        ...
        public Weight GetWeight(DateTime startDate, DateTime? endDate = null)
        {
            ...
            if (endDate == null)
            {
                apiCall = String.Format("/1/user/-/body/log/weight/date/{0}.json", startDate.ToString("yyyy-MM-dd"));
            }
            else
            {
                apiCall = String.Format("/1/user/-/body/log/weight/date/{0}/{1}.json", startDate.ToString("yyyy-MM-dd"), endDate.Value.ToString("yyyy-MM-dd"));
            }
        ...
        public Weight GetWeight(DateTime startDate, DateRangePeriod period)
        {
            ...
            string apiCall = String.Format("/1/user/-/body/log/weight/date/{0}/{1}.json", startDate.ToString("yyyy-MM-dd"), StringEnum.GetStringValue(period));
        ...
        public Fat GetFat(DateTime startDate, DateTime? endDate = null)
        {
            ...
            if (endDate == null)
            {
                apiCall = String.Format("/1/user/-/body/log/fat/date/{0}.json", startDate.ToString("yyyy-MM-dd"));
            }
            else
            {
                apiCall = String.Format("/1/user/-/body/log/fat/date/{0}/{1}.json", startDate.ToString("yyyy-MM-dd"), endDate.Value.ToString("yyyy-MM-dd"));
            }
        ...
        public Fat GetFat(DateTime startDate, DateRangePeriod period)
        {
            ...
            string apiCall = String.Format("/1/user/-/body/log/fat/date/{0}/{1}.json", startDate.ToString("yyyy-MM-dd"), StringEnum.GetStringValue(period));
        ...
        public Food GetFood(DateTime date, string userId = null)
        {
            ...
            string apiCall = String.Format("/1/user/{0}/foods/log/date/{1}.json", userSignifier, date.ToString("yyyy-MM-dd"));
        ...
        {
            RestRequest request = new RestRequest("/1/user/-/friends.json");
        ...
        {
            RestRequest request = new RestRequest("/1/user/-/devices.json");
        ...
        {
            RestRequest request =
                new RestRequest(string.Format("/1/user/-/devices/tracker/{0}/alarms.json", deviceId));
        ...
        private TimeSeriesDataList GetTimeSeries(TimeSeriesResourceType timeSeriesResourceType, DateTime baseDate, string endDateOrPeriod, string userId)
        {
            ...
            string requestUrl = string.Format("/1/user/{0}{1}/date/{2}/{3}.json", userSignifier, StringEnum.GetStringValue(timeSeriesResourceType), baseDate.ToString("yyyy-MM-dd"), endDateOrPeriod);
        ...
        public IntradayData GetIntraDayTimeSeries(IntradayResourceType timeSeriesResourceType, DateTime dayAndStartTime, TimeSpan intraDayTimeSpan)
        {
            ...
            { 
                requestUrl = string.Format("/1/user/-{0}/date/{1}/1d/time/{2}/{3}.json", 
            ...
            {
                requestUrl = string.Format("/1/user/-{0}/date/{1}/1d.json", 
                                        StringEnum.GetStringValue(timeSeriesResourceType), 
                                        dayAndStartTime.ToString("yyyy-MM-dd"));
            }
            //                /1/user/-/activities/calories/date/2011-07-05/1d/time/12:20/12:45.json
            RestRequest request = new RestRequest(requestUrl);
        ...
        {
            string apiCall = string.Format("/1/user/-/heart/date/{0}.json", date.ToString("yyyy-MM-dd"));
            RestRequest request = new RestRequest(apiCall);
        ...
        {
            RestRequest request = new RestRequest("/1/user/-/apiSubscriptions.json");
        ...
        public ApiSubscription AddSubscription(APICollectionType apiCollectionType, string uniqueSubscriptionId, string subscriberId)
        {
            ...
            {
                subscriptionAPIEndpoint = string.Format("/1/user/-/activities/apiSubscriptions/{0}-activities.json", uniqueSubscriptionId);
            }
            else if (apiCollectionType == APICollectionType.body)
            {
                subscriptionAPIEndpoint = string.Format("/1/user/-/body/apiSubscriptions/{0}-body.json", uniqueSubscriptionId);
            }
            else if (apiCollectionType == APICollectionType.foods)
            {
                subscriptionAPIEndpoint = string.Format("/1/user/-/foods/apiSubscriptions/{0}-foods.json", uniqueSubscriptionId);
            }                
            else if (apiCollectionType == APICollectionType.meals)
            {
                subscriptionAPIEndpoint = string.Format("/1/user/-/meals/apiSubscriptions/{0}-meals.json", uniqueSubscriptionId);
            }
            else if (apiCollectionType == APICollectionType.sleep)
            {
                subscriptionAPIEndpoint = string.Format("/1/user/-/sleep/apiSubscriptions/{0}-sleep.json", uniqueSubscriptionId);
            }
            else if (apiCollectionType == APICollectionType.user)
            {
                subscriptionAPIEndpoint = string.Format("/1/user/-/apiSubscriptions/{0}-user.json", uniqueSubscriptionId);
            }
            ...
            {
                subscriptionAPIEndpoint = string.Format("/1/user/-/weight/apiSubscriptions/{0}-weight.json", uniqueSubscriptionId);
            }
        ...
        public ApiSubscription RemoveSubscription(APICollectionType apiCollectionType, string uniqueSubscriptionId)
        {
            ...
            if (apiCollectionType == APICollectionType.activities)
            {
                subscriptionAPIEndpoint = string.Format("/1/user/-/activities/apiSubscriptions/{0}.json", uniqueSubscriptionId);
            }
            else if (apiCollectionType == APICollectionType.body)
            {
                subscriptionAPIEndpoint = string.Format("/1/user/-/body/apiSubscriptions/{0}.json", uniqueSubscriptionId);
            }
            else if (apiCollectionType == APICollectionType.foods)
            {
                subscriptionAPIEndpoint = string.Format("/1/user/-/foods/apiSubscriptions/{0}.json", uniqueSubscriptionId);
            }
            else if (apiCollectionType == APICollectionType.meals)
            {
                subscriptionAPIEndpoint = string.Format("/1/user/-/meals/apiSubscriptions/{0}.json", uniqueSubscriptionId);
            }
            else if (apiCollectionType == APICollectionType.sleep)
            {
                subscriptionAPIEndpoint = string.Format("/1/user/-/sleep/apiSubscriptions/{0}.json", uniqueSubscriptionId);
            }
            else if (apiCollectionType == APICollectionType.user)
            {
                subscriptionAPIEndpoint = string.Format("/1/user/-/apiSubscriptions/{0}.json", uniqueSubscriptionId);
            }
            else if (apiCollectionType == APICollectionType.weight) //untested and the docs don't show it, but the Fitbit4J enum does have this
            {
                subscriptionAPIEndpoint = string.Format("/1/user/-/weight/apiSubscriptions/{0}.json", uniqueSubscriptionId);
            }
        ...
        public Fitbit.Models.BodyMeasurements GetBodyMeasurements(DateTime date, string userId)
        {
            ...
            string apiCall = String.Format("/1/user/{0}/body/date/{1}.json", userSignifier, date.ToString("yyyy-MM-dd"));
        ...
        public Fitbit.Models.BloodPressureData GetBloodPressure(DateTime date, string userId)
        {
            ...
            string apiCall = String.Format("/1/user/{0}/bp/date/{1}.json", userSignifier, date.ToString("yyyy-MM-dd"));
        ...
        public HeartRateLog LogHeartRate(HeartRateLog log, string userId = null)
        {
            ...
            string endPoint = string.Format("/1/user/{0}/heart.json", userSignifier);
        ...
        {
            string subscriptionAPIEndpoint = string.Format("/1/user/-/heart/{0}.json", logId);
        ...
        {
            string apiCall = string.Format("/1/user/-/sleep/date/{0}.json", sleepDate.ToString("yyyy-MM-dd"));
            RestRequest request = new RestRequest(apiCall);
        ...
        private void HandleResponse(IRestResponse response)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    var xmlDeserializer = new RestSharp.Deserializers.JsonDeserializer() { RootElement = "errors" };
        ...
        {
            const string ApiExtention = "/1/user/-/activities/date/{0}-{1}-{2}.json";
