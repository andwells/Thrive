                     08, 10, 11, 08, 09, 07, 08, 10, 11, 09, 
                     07, 06, 05, 06, 08, 07, 09, 10, 11, 08, 
                     07, 09, 06, 08, 10, 09, 07, 08, 09, 10, 
                     11, 12, 09, 08, 10, 11, 12, 10, 09, 08, 
                     08, 11, 10, 09, 08, 07, 06, 10, 11, 10, 
                     08, 09, 10, 08, 09, 08, 07, 06, 10, 09, 
                     08, 07, 09, 10, 08, 07, 09, 10, 10, 11, 
                     08, 09, 07, 10, 08, 09, 07, 10, 11, 08,
                     08, 09, 10, 11, 12, 08, 07, 09, 10, 09, 
                     08, 09, 08, 09, 10, 09, 09, 08, 09, 10, 
                     08, 09, 08, 10, 08, 09, 10, 08, 09, 08,
                     08, 07, 10, 08, 10, 08, 07, 08, 10, 11, 
                     08, 08, 08, 07, 08, 07, 09, 07, 08, 06, 
                     07, 08, 09, 07, 06, 08, 08, 08, 08, 07,
                     07, 07, 08, 07, 08, 07, 08, 07, 08, 09, 
                     07, 08, 07, 08, 08, 07, 08, 08, 08, 08,
                     08, 08, 08, 08, 07, 08, 08, 08, 08, 09,
                     08, 08, 08, 08, 08, 07, 08, 08, 07, 09, 
                     08, 08, 08, 08, 08, 07, 06, 07, 06, 07,
                     06, 08, 09, 08, 07, 08, 06, 07, 08, 07, 
                     08, 09, 07, 08, 06, 08, 07, 08, 08, 08, 
                     07, 08, 07, 08, 07};
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            tb_weight.Text = weightArray[weightArray.Length - 1].ToString();
            tb_sleep.Text = sleepArray[sleepArray.Length - 1].ToString();
            tb_water.Text = waterArray[waterArray.Length - 1].ToString();

            Session["curWeight"] = tb_weight.Text;
            Session["curSleep"] = tb_sleep.Text;
            Session["curWater"] = tb_water.Text;
        ...
        tb_weight.Text = (String)Session["curWeight"];
        tb_sleep.Text = (String)Session["curSleep"];
        tb_water.Text = (String)Session["curWater"];
        ...
        DateTime startDate = new DateTime(2014, 12, 9);
        ...
        for (int i = 0; i < foodArray.Length; i++)
            Chart1.Series["Food"].Points.AddXY(startDate.AddDays(i - 363), foodArray[i]);

        for (int i = 0; i < exerciseArray.Length; i++)
            Chart1.Series["Exercise"].Points.AddXY(startDate.AddDays(i - 363), exerciseArray[i]);

        for (int i = 0; i < waterArray.Length; i++)
            Chart1.Series["Water"].Points.AddXY(startDate.AddDays(i - 363), waterArray[i]);

        for (int i = 0; i < weightArray.Length; i++)
            Chart1.Series["Weight"].Points.AddXY(startDate.AddDays(i - 363), weightArray[i]);
    ...
    protected void b_weightChange_Click(object sender, EventArgs e)
    {
        changeWeight(1);
    }
    protected void b_weightChange2_Click(object sender, EventArgs e)
    {
        changeWeight(-1);
    }

    protected void changeWeight(int x)
    {
        int cur = Convert.ToInt32((String)Session["curWeight"]);
        cur += x;
        Session["curWeight"] = cur.ToString();
    }

    protected void b_waterChange_Click(object sender, EventArgs e)
    {
        changeWater(1);
    }
    protected void b_waterChange2_Click(object sender, EventArgs e)
    {
        changeWater(-1);
    }

    protected void changeWater(int x)
    {
        int cur = Convert.ToInt32((String)Session["curWater"]);
        cur += x;
        Session["curWater"] = cur.ToString();
    }
    protected void b_sleepChange_Click(object sender, EventArgs e)
    {
        changeSleep(1);
    }
    protected void b_sleepChange2_Click(object sender, EventArgs e)
    {
        changeSleep(-1);
    }

    protected void changeSleep(int x)
    {
        int cur = Convert.ToInt32((String)Session["curSleep"]);
        cur += x;
        Session["curSleep"] = cur.ToString();
    }
}
