...
public partial class vc2Dashboard : System.Web.UI.Page
{
    ...
    int[] weightArray = {240, 240, 240, 240, 240, 240, 240, 240, 240, 240,
                     ...
                     235, 235, 236, 237, 238, 237, 236, 235, 237, 238, 
    ...
    protected void changeView(DateTime start, DateTime end)
    {
        ...
        DateTime test = new DateTime(1970, 1, 1);
        
        //DateTime startX = DateTime.Parse(((int)Chart1.ChartAreas[0].AxisX.Minimum).ToString());
        //DateTime endX = DateTime.Parse(((int)Chart1.ChartAreas[0].AxisX.Maximum).ToString());
        int todayDate = (int)DateTime.Today.ToOADate();
        int beginning = todayDate - currentArray.Length;

        int startX = (int)Chart1.ChartAreas[0].AxisX.Minimum - beginning;
        int endX = (int)Chart1.ChartAreas[0].AxisX.Maximum - beginning;
